...
//		unicode --> special + lang char + ASCII
		...
		char c2 = 'b'; //a-z
		char c3 = '0'; //0-9: 48 to 57
		char c4 = 'G'; //A-Z: 65 to 90
		char c5 = '$';
		System.out.println(c1); //a
		System.out.println(c2);//0
		System.out.println(c1+c2);//97+98=195
		System.out.println(c2-c1);System.out.println('0'+'9');//48+57 = 105
...
//		range: true/false
		...
		byte P1 = 127;
		byte P2 = 125;
		int P3= (P1 + P2); //127+125 = 252
		System.out.println(P2);//3
		
		int I=-2147483648;
		int J=-2147483648;
		long K=(long)(I+J); //(I+J = -4294967296 ==> 0)
		System.out.println(K); //-4294967296
